...
const About = () => {
  return (
    <section id="about" className="py-16 md:py-20 bg-emerald-50 dark:bg-slate-800">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center mb-12 md:mb-16">
          <h2 className="text-2xl md:text-4xl font-bold text-gray-900 dark:text-slate-100 mb-4 md:mb-6">Understanding Homeopathy</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          {[
            ...
            <div 
              key={index}
              className={`bg-white dark:bg-slate-700 p-6 md:p-8 rounded-2xl shadow-lg group transition-all duration-500 hover:shadow-xl transform hover:-translate-y-2 overflow-hidden relative`}
            >
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-lg md:text-xl font-semibold text-gray-900 dark:text-slate-100 mb-3 md:mb-4 group-hover:translate-x-2 transition-transform duration-300">
                  {item.title}
                </h3>
                <p className="text-sm md:text-base text-gray-600 dark:text-slate-300 group-hover:translate-x-2 transition-transform duration-300 delay-75">
                  {item.description}
                </p>
              </div>
        ...
        <div className="mt-16 md:mt-20">
          <div className="bg-white dark:bg-slate-700 rounded-2xl shadow-lg overflow-hidden transform transition-all duration-300 hover:shadow-xl">
            <div className="grid md:grid-cols-2 items-center">
              <div className="p-6 md:p-12">
                <h3 className="text-xl md:text-2xl font-bold text-gray-900 dark:text-slate-100 mb-6">The Science of Homeopathy</h3>
                <div className="space-y-4">
                  {[
                    ...
                    <div key={index} className="flex items-start gap-4 group">
                      <div className="bg-emerald-100 dark:bg-indigo-900/30 p-3 rounded-full group-hover:bg-emerald-200 dark:group-hover:bg-indigo-900/50 transition-colors">
                        {item.icon}
                      </div>
                      <div>
                        <h4 className="font-semibold text-gray-900 dark:text-slate-100 text-base md:text-lg">{item.title}</h4>
                        <p className="text-sm md:text-base text-gray-600 dark:text-slate-300">{item.description}</p>
                      </div>
                    </div>
                  ))}
                </div>
              </div>
              <div className="bg-emerald-50 dark:bg-slate-800/50 p-6 md:p-12">
                <img
