          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="text-white space-y-8">
              ...
              <div>
                ...
                <p className="text-lg text-emerald-50/90 leading-relaxed animate-slide-up">
              ...
              {/* Stats Card */}
              <div className="bg-white/10 backdrop-blur-lg p-6 rounded-2xl border border-emerald-500/20 hover:bg-white/15 transition-all duration-300">
                <div className="grid grid-cols-2 gap-6">
                  {[
                    ...
                    <div key={index} className="text-center group">
                      <h3 className="text-3xl font-bold text-emerald-300 group-hover:text-emerald-200 transition-colors mb-2">{stat.value}</h3>
                      {stat.stars ? (
            ...
            <div className="lg:ml-auto">
              <div className="bg-white/10 backdrop-blur-lg p-8 rounded-2xl border border-emerald-500/20 hover:bg-white/15 transition-all duration-300 transform hover:scale-[1.02]">
                <h2 className="text-2xl font-semibold text-white mb-8 group-hover:text-white">Why Choose Homeopathy?</h2>
