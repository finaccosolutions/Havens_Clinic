...
const Contact = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    window.open(`https://wa.me/918281496707?text=${whatsappMessage}`, '_blank');
    ...
    <section id="contact" className="py-16 md:py-20 bg-emerald-50 dark:bg-gray-900 overflow-x-hidden">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12">
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 md:p-8 transform hover:scale-[1.02] transition-all duration-300 w-full relative overflow-hidden group">
            {/* Decorative gradient border */}
            <div className="absolute inset-0 bg-gradient-to-r from-emerald-500 via-teal-500 to-emerald-500 opacity-0 group-hover:opacity-100 transition-opacity duration-300" style={{ padding: '2px' }}>
              <div className="absolute inset-0 bg-white dark:bg-gray-800 rounded-2xl"></div>
            </div>
          ...
          <div className="lg:pl-6">
            <div className="bg-gradient-to-br from-emerald-100 to-teal-50 dark:from-gray-800 dark:to-gray-700 rounded-2xl shadow-lg p-6 md:p-8 h-full transform hover:scale-[1.02] transition-all duration-300 relative group overflow-hidden">
              {/* Animated border */}
              <div className="absolute inset-0 bg-gradient-to-r from-emerald-500 via-teal-500 to-emerald-500 opacity-0 group-hover:opacity-100 transition-opacity duration-300" style={{ padding: '2px' }}>
                <div className="absolute inset-0 bg-gradient-to-br from-emerald-100 to-teal-50 dark:from-gray-800 dark:to-gray-700 rounded-2xl"></div>
              </div>
                  ...
                  {[
                    {
                      ...
                      title: "Phone",
                      info: ["0483 2714400","+91 8281496707"]
                    },
                    {
                  ...
                  <div className="flex gap-4">
                    {[
                      ...
                      },
                      {
                        ...
                        href: "https://www.instagram.com/havens_clinic"
                      },
                      {
                      ...
                      <a
                        ...
                        className="bg-gradient-to-r from-emerald-500 to-teal-500 p-3 rounded-full hover:from-emerald-400 hover:to-teal-400 transition-all duration-300 hover:scale-110 group"
                      >
